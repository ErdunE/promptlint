...
interface DiagnosticTest {
  ...
  category: 'edge_case' | 'analytical_intent' | 'code_confidence' | 'writing_clarity' | 'research_methodology' | 'complex_multi_domain';
  critical: boolean;
}
...
function analyzeDiagnosticResult(
  test: DiagnosticTest,
  actualIntent: string,
  actualDomain: string, 
...
async function runDiagnosticValidation() {
  ...
  console.log("Sample Size: 24 prompts across 6 categories");
  ...
  const diagnosticTests: DiagnosticTest[] = [
    ...
    // Analytical Intent Pattern Testing (identify systemic issues)
    {
    ...
    },
    {
      ...
      prompt: "analyze and compare different algorithms",
      expectedIntent: "analytical", 
      expectedDomain: "analysis",
      expectedConfidence: 80,
    ...
    },
    {
      ...
      prompt: "analyze market trends for competitive advantage", 
      expectedIntent: "analytical",
      expectedDomain: "analysis",
      expectedConfidence: 85,
      expectedTemplates: ["task_io", "bullet"],
    ...
    },
    {
      ...
      prompt: "analyze quarterly revenue data and identify growth opportunities",
      expectedIntent: "analytical",
      expectedDomain: "analysis",
      expectedConfidence: 85,
      expectedTemplates: ["bullet", "task_io"],
    ...
    // Code Domain Confidence Testing (calibration issues)
    {
    ...
    },
    {
      ...
      prompt: "create database schema for user management",
      expectedIntent: "instructional",
      expectedDomain: "code",
      expectedConfidence: 85,
      expectedTemplates: ["task_io"],
    ...
    },
    {
      ...
      prompt: "integrate third-party payment API with error handling",
      expectedIntent: "instructional",
      expectedDomain: "code",
      expectedConfidence: 90,
      expectedTemplates: ["task_io", "sequential"],
    ...
    },
    {
      ...
      prompt: "compose professional email to project stakeholders",
      expectedIntent: "generative",
      expectedDomain: "writing",
    ...
    },
    {
      ...
      prompt: "write creative story with character development and plot twists",
      expectedIntent: "creative",
      expectedDomain: "writing",
      expectedConfidence: 90,
    ...
    {
      name: "Methodology Investigation",
      prompt: "investigate agile development methodologies",
      expectedIntent: "investigative",
      expectedDomain: "research",
      expectedConfidence: 80,
      expectedTemplates: ["bullet", "task_io"],
    ...
    },
    {
      ...
      prompt: "explore solutions for scalability challenges",
      expectedIntent: "investigative",
      expectedDomain: "research",
      expectedConfidence: 75,
      expectedTemplates: ["bullet", "sequential"],
    ...
    // Complex Multi-Domain Testing (integration challenges)
    {
    ...
    {
      name: "Multi-Domain Task 3",
      prompt: "write technical article explaining database optimization techniques",
      expectedIntent: "explanatory",
      expectedDomain: "writing",
      expectedConfidence: 80,
      expectedTemplates: ["sequential", "bullet"],
    ...
    {
      name: "Multi-Domain Task 4",
      prompt: "debug authentication system and create troubleshooting documentation",
      expectedIntent: "debugging",
      expectedDomain: "code",
      expectedConfidence: 80,
  ...
  for (const test of diagnosticTests) {
    try {
      ...
      // Extract semantic analysis if available (may not be accessible)
      const semanticIntent = "unknown"; // Would extract from candidates metadata if available
      ...
      console.log(`   Domain: ${domainResult.domain} (${domainResult.confidence} confidence)`);
